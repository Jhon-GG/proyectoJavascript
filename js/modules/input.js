...
// class alumFilter extends HTMLElement {
//     constructor() {
//       super();
...
//         </style>
//         <label for="search">
//             <input class="albumSearch" type="text" required="" placeholder="What do you want to listen to?" id="search">
...
//                 </svg>
//             </div>
//             <button class="albumSearchBTN" type="reset">
...
//       if (query.length === 0) {
//         this.albumSearchBTN.innerHTML = ''; // Limpiar la lista si la búsqueda está vacía
//         return;
//       }
  
//       const albums = await this.fetchAlbums(query);
//       this.renderAlbums(albums);
//     }
  
//     async fetchAlbums(query) {
//       try {
//         const response = await fetch(`https://tu-api.com/albums?search=${query}`);
//         if (!response.ok) {
//           throw new Error('Error al obtener los álbumes de la API');
//         }
...
//     renderAlbums(albums) {
//       this.albumList.innerHTML = ''; // Limpiar la lista antes de mostrar los nuevos resultados
